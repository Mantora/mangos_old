...
{                                                                            /*thread-safe*/
    ...
    /*0x217*/ { "CMSG_GMTICKET_CLOSETICKET",                    STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketCloseTicketOpcode },
    /*0x218*/ { "SMSG_GMTICKET_CLOSETICKET",                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               },
    ...
    /*0x402*/ { "SMSG_MIRRORIMAGE_DATA",                        STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     },
